...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: "Apolo · Centro Capilar y Estético", description: "Tratamientos capilares y estéticos con criterio profesional en el Microcentro porteño." },
